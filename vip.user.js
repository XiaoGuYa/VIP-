// ==UserScript==
// @name              视频解析助手
// @namespace         https://github.com/guchen666/VIP-
// @version           1.0.7
...
// @author            XiaoGu
// @license           MIT
// @supportURL        https://github.com/guchen666/VIP-
...
(function () {
  ...
  let api = [
    {name: '线路1', url: 'https://z1.m1907.cn/?jx='},
    ...
    {name: '线路6', url: 'https://jx.ab33.top/vip/?url='},
    {name: '线路7', url: 'https://jx.youyitv.com/?url='},
    {name: '线路8', url: 'https://www.1717yun.com/jx/ty.php?url='},
    {name: '线路9', url: 'https://jx.618g.com/?url='},
    {name: '线路10', url: 'http://jx.kukan.vip/?url='},  //添加线路请复制这一行，进行添加
    {name: '线路11', url: 'https://z1.m1907.cn/?jx='}];
...
let main = {
    showButton: function () {
      if (location.host.match(/youku|iqiyi|le|qq|tudou|mgtv|sohu|acfun|bilibili|pptv|baofeng|yinyuetai/ig)) {
        ...
        //反馈按钮
        $('.h-ol').append(`<li><a target="_blank" style="color: #999;" href="https://github.com/guchen666/VIP-/issues">点击反馈</a></li>`);
